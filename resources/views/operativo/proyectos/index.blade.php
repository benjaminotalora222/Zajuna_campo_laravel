...
<div class="px-8 py-8 max-w-screen-xl mx-auto" style="color:#1c2b16;">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            {{-- Búsqueda inline --}}
            <form method="GET" action="{{ route('operativo.proyectos.index') }}" class="flex items-center gap-2">
                <div class="relative">
...
function abrirModalEditar(p) {
    ...
    document.getElementById('formProyecto').action        = '/operativo/proyectos/' + p.id;
...
function confirmarEliminar(id, nombre) {
    document.getElementById('formEliminar').action    = '/operativo/proyectos/' + id;
