...
<head>
    ...
    <title>Panel Proveedor — Zajuna Campo</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="min-h-screen flex items-center justify-center" style="background:#fdf9ee;">
    <div class="text-center">
        <p class="text-xs font-bold uppercase tracking-widest mb-3" style="color:#71277a;">Proveedor</p>
        <h1 class="text-2xl font-bold mb-2" style="color:#1f3410;">Panel Proveedor</h1>
