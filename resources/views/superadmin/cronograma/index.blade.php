...
<div class="px-8 py-8 max-w-screen-xl mx-auto" style="color:#1c2b16;">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            {{-- Filtro tipo --}}
            <form method="GET" action="{{ route('superadmin.cronograma.index') }}" class="flex gap-2">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-2">
        <div class="flex items-center justify-between px-6 py-4 border-b" style="border-color:#f3f0e8;">
            <a href="{{ route('superadmin.cronograma.index', ['anio' => $mesAnterior->year, 'mes' => $mesAnterior->month, 'tipo' => $filtroTipo]) }}"
            ...
            <a href="{{ route('superadmin.cronograma.index', ['anio' => $mesSiguiente->year, 'mes' => $mesSiguiente->month, 'tipo' => $filtroTipo]) }}"
               class="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-gray-50 border transition"
               style="border-color:#e7e0cc; color:#5a5a4f;">
...
const ROUTES = {
    ...
    show:    '/superadmin/cronograma/',
    update:  '/superadmin/cronograma/',
    destroy: '/superadmin/cronograma/',
